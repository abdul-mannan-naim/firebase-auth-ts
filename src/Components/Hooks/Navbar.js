            ...
            <div class="drawer">
                ...
                <div class="drawer-content flex flex-col">
                    ...
                    <div class="w-full navbar ">
                        ...
                        <div class="flex-1 px-2 mx-2"><NavLink className="rounded-2xl mx-3 text-2xl font-bold text-accent " to="/" > eShop Bazar  </NavLink></div>
                        <div class="flex-none hidden lg:block">
                            <ul class="menu menu-horizontal">
                                {/* <!-- Navbar menu content here --> */}

                                <li><NavLink className="rounded-2xl mx-3 " to="/product" > Product </NavLink></li>
                                <li><NavLink className="rounded-2xl mx-3 " to="/about" >  About </NavLink></li>
                                {
